...
class PullsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get index" do
    ...
    get repo_pulls_path(@repository)
  ...
  test "should force the pr type even when the query says is:issue" do
    ...
    get repo_pulls_path(@repository, q: "is:issue state:open")
  ...
  test "should link cards to the pulls detail route" do
    ...
    assert_response :success
    assert_select "a[href=?]", repo_pull_path(@repository, 7)
  end
  ...
  test "should render issues and pull requests tabs" do
    ...
    assert_select "a[href=?][aria-current=?]", repo_pulls_path(@repository), "page", text: "Pull requests"
  end
  ...
  test "should show an individual pull request" do
    ...
    get repo_pull_path(@repository, pull.number)
  ...
  test "should redirect to the pulls index when a pull request is not found" do
    ...
    get repo_pull_path(@repository, 999)

    assert_redirected_to repo_pulls_path(@repository)
  end
  ...
  test "should redirect to the issue page when the number is not a pull request" do
    ...
    get repo_pull_path(@repository, issue.number)

    assert_redirected_to repo_issue_path(@repository, issue.number)
  end
  ...
  test "should refresh all pull requests and redirect to the pulls index" do
    ...
    post refresh_repo_pulls_path(@repository)
  ...
  test "should refresh a single pull request and redirect to its page" do
    ...
    post refresh_repo_pull_path(@repository, pull.number)
  ...
  test "should list commits for a pull request" do
    ...
    get repo_pull_commits_path(@repository, pull.number)
  ...
  test "should list changed files with their diffs" do
    ...
    get repo_pull_files_path(@repository, pull.number)
  ...
  test "should redirect the commits tab to the issue page for a plain issue" do
    ...
    get repo_pull_commits_path(@repository, issue.number)
  ...
  test "should render the tab bar with cached counts and diffstat" do
    ...
    assert_select "a[href=?]", repo_pull_path(@repository, pull.number)
    assert_select "a[href=?][aria-current=page]", repo_pull_commits_path(@repository, pull.number)
  ...
  test "should view a file's contents at the pull request head revision" do
    ...
    get repo_pull_file_path(@repository, pull.number, "README.md")
  ...
  test "should show markdown source when the source toggle is used" do
    ...
    get repo_pull_file_path(@repository, pull.number, "README.md", display: "source")
  ...
  test "should not offer a toggle for a non-markdown file" do
    ...
    get repo_pull_file_path(@repository, pull.number, "app/models/issue.rb")
  ...
  test "should report a file that could not be read" do
    ...
    get repo_pull_file_path(@repository, pull.number, "gone.rb")
  ...
  test "should link changed filenames to the file viewer" do
    ...
    assert_response :success
    assert_select "a[href=?]", repo_pull_file_path(@repository, pull.number, "README.md")
  end
  ...
  test "should not link a removed file to the viewer" do
    ...
    assert_response :success
    assert_select "a[href=?]", repo_pull_file_path(@repository, pull.number, "README.md"), count: 0
  end
